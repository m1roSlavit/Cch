...
namespace lab_1_xml_json
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                formatter.Serialize(fs, tournamentParticipants.ToList<TournamentParticipant>());
            }
        }
        ...
        {
            List<TournamentParticipant> data = JsonConvert.DeserializeObject<List<TournamentParticipant>>(File.ReadAllText("./tournament-participants.json"));
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                data = (List<TournamentParticipant>)formatter.Deserialize(fs);
            }
            ...
            using (FileStream fs = new FileStream("./tournament-participants.xml", FileMode.Create, FileAccess.Write))
            {
                formatter.Serialize(fs, filteredData.ToList<TournamentParticipant>());
            }
        }
    }
    [Serializable]
